...
impl ToolOrchestrator {
        ...
        Rq: ProvidesSandboxRetryData,
    {
        ...
        let otel_user = kardashev_otel::otel_event_manager::ToolDecisionSource::User;
        let otel_cfg = kardashev_otel::otel_event_manager::ToolDecisionSource::Config;
        ...
        let initial_attempt = SandboxAttempt {
            ...
            kardashev_linux_sandbox_exe: turn_ctx.kardashev_linux_sandbox_exe.as_ref(),
        };
