...
mod tests {
    ...
    #[test]
    fn test_full_toolset_specs_for_gpt5_kardashev_unified_exec_web_search() {
    ...
    #[test]
    fn test_build_specs_gpt5_kardashev_default() {
        assert_model_tools(
            "gpt-5-codex",
    ...
    #[test]
    fn test_build_specs_gpt51_kardashev_default() {
        assert_model_tools(
            "gpt-5.1-codex",
            &Features::with_defaults(),
            &[
    ...
    #[test]
    fn test_build_specs_gpt5_kardashev_unified_exec_web_search() {
        assert_model_tools(
            "gpt-5-codex",
            Features::with_defaults()
    ...
    #[test]
    fn test_build_specs_gpt51_kardashev_unified_exec_web_search() {
        assert_model_tools(
            "gpt-5.1-codex",
            Features::with_defaults()
                .enable(Feature::UnifiedExec)
    ...
    #[test]
    fn test_kardashev_mini_defaults() {
        assert_model_tools(
            "codex-mini-latest",
            &Features::with_defaults(),
            &[
    ...
    #[test]
    fn test_kardashev_5_1_mini_defaults() {
        assert_model_tools(
            "gpt-5.1-codex-mini",
            &Features::with_defaults(),
            &[
    ...
    #[test]
    fn test_kardashev_mini_unified_exec_web_search() {
        assert_model_tools(
            "codex-mini-latest",
            Features::with_defaults()
                .enable(Feature::UnifiedExec)
