...
//!
//! The [`McpConnectionManager`] owns one [`kardashev_rmcp_client::RmcpClient`] per
...
use kardashev_protocol::protocol::McpStartupCompleteEvent;
use kardashev_protocol::protocol::McpStartupFailure;
use kardashev_protocol::protocol::McpStartupStatus;
use kardashev_protocol::protocol::McpStartupUpdateEvent;
...
use kardashev_rmcp_client::RmcpClient;
use kardashev_rmcp_client::SendElicitation;
...
fn mcp_init_error_display(
    ...
    {
        format!(
            "GitHub MCP does not support OAuth. Log in by adding a personal access token (https://github.com/settings/personal-access-tokens) to your environment and config.toml:\n[mcp_servers.{server_name}]\nbearer_token_env_var = KARDASHEV_GITHUB_PERSONAL_ACCESS_TOKEN"
        )
...
mod tests {
    use super::*;
    use kardashev_protocol::protocol::McpAuthStatus;
