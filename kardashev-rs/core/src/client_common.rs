...
pub use kardashev_api::common::ResponseEvent;
use kardashev_apply_patch::APPLY_PATCH_TOOL_INSTRUCTIONS;
...
mod tests {
    ...
    use kardashev_api::ResponsesApiRequest;
    use kardashev_api::common::OpenAiVerbosity;
    use kardashev_api::common::TextControls;
    ...
    fn serializes_text_schema_with_strict_format() {
        ...
        assert_eq!(
            format.get("name"),
            Some(&serde_json::Value::String("kardashev_output_schema".into()))
        );
        assert_eq!(
            format.get("type"),
