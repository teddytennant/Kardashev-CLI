...
use kardashev_apply_patch::ApplyPatchAction;
use kardashev_apply_patch::ApplyPatchFileChange;
use std::collections::HashMap;
use std::path::PathBuf;

pub const KARDASHEV_APPLY_PATCH_ARG1: &str = "--codex-run-as-apply-patch";
...
pub(crate) enum InternalApplyPatchInvocation {
    ...
    /// exec with [`KARDASHEV_APPLY_PATCH_ARG1`] to realize the `apply_patch` call,
