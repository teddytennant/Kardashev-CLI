...
use kardashev_file_search as file_search;
...
pub(crate) async fn get_conversations(
    ...
    let mut root = kardashev_home.to_path_buf();
...
///
/// Directory layout: `~/.kardashev/sessions/YYYY/MM/DD/rollout-YYYY-MM-DDThh-mm-ss-<uuid>.jsonl`
