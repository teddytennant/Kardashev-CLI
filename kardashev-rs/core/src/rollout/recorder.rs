...
use kardashev_protocol::protocol::ResumedHistory;
use kardashev_protocol::protocol::RolloutItem;
use kardashev_protocol::protocol::RolloutLine;
use kardashev_protocol::protocol::SessionMeta;
...
///
/// ```ignore
/// $ jq -C . ~/.kardashev/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// $ fx ~/.kardashev/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// ```
#[derive(Clone)]
...
fn create_log_file(
    ...
    // Resolve ~/.kardashev/sessions/YYYY/MM/DD and create it if missing.
    let timestamp = OffsetDateTime::now_local()
        .map_err(|e| IoError::other(format!("failed to get local time: {e}")))?;
    let mut dir = config.kardashev_home.clone();
