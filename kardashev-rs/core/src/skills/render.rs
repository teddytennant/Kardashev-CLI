...
pub fn render_skills_section(skills: &[SkillMetadata]) -> Option<String> {
    ...
    lines.push("These skills are discovered at startup from ~/.kardashev/skills; each entry shows name, description, and file path so you can open the source for full instructions. Content is not inlined to keep context lean.".to_string());
