...
use crate::spawn::KARDASHEV_SANDBOX_NETWORK_DISABLED_ENV_VAR;
...
impl SandboxManager {
    ...
    pub(crate) fn transform(
        ...
        if !policy.has_full_network_access() {
            env.insert(
                KARDASHEV_SANDBOX_NETWORK_DISABLED_ENV_VAR.to_string(),
                "1".to_string(),
            );
        }
        ...
        let (command, sandbox_env, arg0_override) = match sandbox {
            ...
            SandboxType::MacosSeatbelt => {
                ...
                seatbelt_env.insert(KARDASHEV_SANDBOX_ENV_VAR.to_string(), "seatbelt".to_string());
                let mut args =
            ...
            SandboxType::LinuxSeccomp => {
                let exe = kardashev_linux_sandbox_exe
