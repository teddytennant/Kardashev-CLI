...
async fn responses_stream_includes_subagent_header_on_review() {
    ...
    let kardashev_home = TempDir::new().expect("failed to create TempDir");
    ...
    let client = ModelClient::new(
        ...
        summary,
        conversation_id,
        SessionSource::SubAgent(kardashev_protocol::protocol::SubAgentSource::Review),
    );
...
async fn responses_stream_includes_subagent_header_on_other() {
    ...
    let client = ModelClient::new(
        ...
        summary,
        conversation_id,
        SessionSource::SubAgent(kardashev_protocol::protocol::SubAgentSource::Other(
            "my-task".to_string(),
        )),
    );
