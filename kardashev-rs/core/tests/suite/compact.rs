...
use kardashev_core::compact::SUMMARIZATION_PROMPT;
use kardashev_core::compact::SUMMARY_PREFIX;
...
async fn auto_compact_counts_encrypted_reasoning_before_last_user() {
    ...
    let compacted_history = vec![kardashev_protocol::models::ResponseItem::Message {
        id: None,
