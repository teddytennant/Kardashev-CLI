...
fn expected_models_for_api_key() -> Vec<ModelPreset> {
    vec![
        gpt_5_1_kardashev_max(),
        gpt_5_1_codex(),
        gpt_5_1_kardashev_mini(),
        gpt_5_1(),
    ]
}
...
fn gpt_5_1_kardashev_max() -> ModelPreset {
    ModelPreset {
...
fn gpt_5_1_codex() -> ModelPreset {
    ModelPreset {
        ...
        is_default: false,
        upgrade: Some(gpt_5_1_kardashev_max_upgrade()),
        show_in_picker: true,
    }
}

fn gpt_5_1_kardashev_mini() -> ModelPreset {
    ModelPreset {
...
fn gpt_5_1_kardashev_max_upgrade() -> kardashev_protocol::openai_models::ModelUpgrade {
    kardashev_protocol::openai_models::ModelUpgrade {
        id: "gpt-5.1-codex-max".to_string(),
