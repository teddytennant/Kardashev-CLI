...
use kardashev_core::protocol::InitialHistory;
use kardashev_core::protocol::ResumedHistory;
use kardashev_core::protocol::RolloutItem;
use kardashev_core::protocol::TurnContextItem;
...
fn resume_history(config: &kardashev_core::config::Config, previous_model: &str, rollout_path: &std::path::Path) -> InitialHistory {
