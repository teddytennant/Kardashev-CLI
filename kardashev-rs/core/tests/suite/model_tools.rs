...
async fn model_selects_expected_tools() {
    ...
    let kardashev_tools = collect_tool_identifiers_for_model("codex-mini-latest").await;
    assert_eq!(
        kardashev_tools,
        vec![
    ...
    let gpt5_kardashev_tools = collect_tool_identifiers_for_model("gpt-5-codex").await;
    assert_eq!(
        gpt5_kardashev_tools,
        vec![
    ...
    let gpt51_kardashev_tools = collect_tool_identifiers_for_model("gpt-5.1-codex").await;
    assert_eq!(
        gpt51_kardashev_tools,
        vec![
            "shell_command".to_string(),
            "list_mcp_resources".to_string(),
            "list_mcp_resource_templates".to_string(),
