...
use base64::Engine;
use kardashev_utils_image::load_and_resize_to_fit;
...
use kardashev_utils_image::error::ImageProcessingError;
...
// (Moved event mapping logic into kardashev-core to avoid coupling protocol to UI-facing events.)
