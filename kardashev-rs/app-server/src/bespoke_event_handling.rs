use crate::kardashev_message_processor::ApiVersion;
use crate::kardashev_message_processor::PendingInterrupts;
use crate::kardashev_message_processor::TurnSummary;
use crate::kardashev_message_processor::TurnSummaryStore;
use crate::outgoing_message::OutgoingMessageSender;
use kardashev_app_server_protocol::AccountRateLimitsUpdatedNotification;
use kardashev_app_server_protocol::AgentMessageDeltaNotification;
use kardashev_app_server_protocol::ApplyPatchApprovalParams;
use kardashev_app_server_protocol::ApplyPatchApprovalResponse;
use kardashev_app_server_protocol::ApprovalDecision;
use kardashev_app_server_protocol::CodexErrorInfo as V2CodexErrorInfo;
use kardashev_app_server_protocol::CommandAction as V2ParsedCommand;
use kardashev_app_server_protocol::CommandExecutionOutputDeltaNotification;
use kardashev_app_server_protocol::CommandExecutionRequestApprovalParams;
use kardashev_app_server_protocol::CommandExecutionRequestApprovalResponse;
use kardashev_app_server_protocol::CommandExecutionStatus;
use kardashev_app_server_protocol::ContextCompactedNotification;
use kardashev_app_server_protocol::ErrorNotification;
use kardashev_app_server_protocol::ExecCommandApprovalParams;
use kardashev_app_server_protocol::ExecCommandApprovalResponse;
use kardashev_app_server_protocol::FileChangeOutputDeltaNotification;
use kardashev_app_server_protocol::FileChangeRequestApprovalParams;
use kardashev_app_server_protocol::FileChangeRequestApprovalResponse;
use kardashev_app_server_protocol::FileUpdateChange;
use kardashev_app_server_protocol::InterruptConversationResponse;
use kardashev_app_server_protocol::ItemCompletedNotification;
use kardashev_app_server_protocol::ItemStartedNotification;
use kardashev_app_server_protocol::McpToolCallError;
use kardashev_app_server_protocol::McpToolCallResult;
use kardashev_app_server_protocol::McpToolCallStatus;
use kardashev_app_server_protocol::PatchApplyStatus;
use kardashev_app_server_protocol::PatchChangeKind as V2PatchChangeKind;
use kardashev_app_server_protocol::ReasoningSummaryPartAddedNotification;
use kardashev_app_server_protocol::ReasoningSummaryTextDeltaNotification;
use kardashev_app_server_protocol::ReasoningTextDeltaNotification;
use kardashev_app_server_protocol::SandboxCommandAssessment as V2SandboxCommandAssessment;
use kardashev_app_server_protocol::ServerNotification;
use kardashev_app_server_protocol::ServerRequestPayload;
use kardashev_app_server_protocol::ThreadItem;
use kardashev_app_server_protocol::ThreadTokenUsage;
use kardashev_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use kardashev_app_server_protocol::Turn;
use kardashev_app_server_protocol::TurnCompletedNotification;
use kardashev_app_server_protocol::TurnDiffUpdatedNotification;
use kardashev_app_server_protocol::TurnError;
use kardashev_app_server_protocol::TurnInterruptResponse;
use kardashev_app_server_protocol::TurnPlanStep;
use kardashev_app_server_protocol::TurnPlanUpdatedNotification;
use kardashev_app_server_protocol::TurnStatus;
use kardashev_core::CodexConversation;
use kardashev_core::parse_command::shlex_join;
...
use kardashev_core::protocol::FileChange as CoreFileChange;
...
use kardashev_core::protocol::ReviewDecision;
use kardashev_core::protocol::TokenCountEvent;
use kardashev_core::protocol::TurnDiffEvent;
use kardashev_core::review_format::format_review_findings_block;
use kardashev_core::review_prompts;
use kardashev_protocol::ConversationId;
use kardashev_protocol::plan_tool::UpdatePlanArgs;
use kardashev_protocol::protocol::ReviewOutputEvent;
    ...
    match msg {
        ...
        EventMsg::Error(ev) => {
            let turn_error = TurnError {
                message: ev.message,
                kardashev_error_info: ev.kardashev_error_info.map(V2CodexErrorInfo::from),
            };
...
mod tests {
    ...
    use anyhow::anyhow;
    use anyhow::bail;
    use kardashev_app_server_protocol::TurnPlanStepStatus;
    use kardashev_core::protocol::CreditsSnapshot;
    use kardashev_core::protocol::McpInvocation;
    use kardashev_core::protocol::RateLimitSnapshot;
    use kardashev_core::protocol::RateLimitWindow;
    use kardashev_core::protocol::TokenUsage;
    use kardashev_core::protocol::TokenUsageInfo;
    use kardashev_protocol::plan_tool::PlanItemArg;
    use kardashev_protocol::plan_tool::StepStatus;
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                kardashev_error_info: Some(V2CodexErrorInfo::InternalServerError),
            },
            &turn_summary_store,
        )
        .await;
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                kardashev_error_info: Some(V2CodexErrorInfo::Other),
            },
            &turn_summary_store,
        )
        .await;
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                kardashev_error_info: Some(V2CodexErrorInfo::BadRequest),
            },
            &turn_summary_store,
        )
        .await;
