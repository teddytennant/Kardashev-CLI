...
use chrono::DateTime;
use chrono::Utc;
use kardashev_app_server_protocol::Account;
use kardashev_app_server_protocol::AccountLoginCompletedNotification;
use kardashev_app_server_protocol::AccountUpdatedNotification;
use kardashev_app_server_protocol::AddConversationListenerParams;
use kardashev_app_server_protocol::AddConversationSubscriptionResponse;
use kardashev_app_server_protocol::ArchiveConversationParams;
use kardashev_app_server_protocol::ArchiveConversationResponse;
use kardashev_app_server_protocol::AskForApproval;
use kardashev_app_server_protocol::AuthMode;
use kardashev_app_server_protocol::AuthStatusChangeNotification;
use kardashev_app_server_protocol::CancelLoginAccountParams;
use kardashev_app_server_protocol::CancelLoginAccountResponse;
use kardashev_app_server_protocol::CancelLoginChatGptResponse;
use kardashev_app_server_protocol::ClientRequest;
use kardashev_app_server_protocol::CommandExecParams;
use kardashev_app_server_protocol::ConversationGitInfo;
use kardashev_app_server_protocol::ConversationSummary;
use kardashev_app_server_protocol::ExecOneOffCommandResponse;
use kardashev_app_server_protocol::FeedbackUploadParams;
use kardashev_app_server_protocol::FeedbackUploadResponse;
use kardashev_app_server_protocol::FuzzyFileSearchParams;
use kardashev_app_server_protocol::FuzzyFileSearchResponse;
use kardashev_app_server_protocol::GetAccountParams;
use kardashev_app_server_protocol::GetAccountRateLimitsResponse;
use kardashev_app_server_protocol::GetAccountResponse;
use kardashev_app_server_protocol::GetAuthStatusParams;
use kardashev_app_server_protocol::GetAuthStatusResponse;
use kardashev_app_server_protocol::GetConversationSummaryParams;
use kardashev_app_server_protocol::GetConversationSummaryResponse;
use kardashev_app_server_protocol::GetUserAgentResponse;
use kardashev_app_server_protocol::GetUserSavedConfigResponse;
use kardashev_app_server_protocol::GitDiffToRemoteResponse;
use kardashev_app_server_protocol::GitInfo as ApiGitInfo;
use kardashev_app_server_protocol::InputItem as WireInputItem;
use kardashev_app_server_protocol::InterruptConversationParams;
use kardashev_app_server_protocol::JSONRPCErrorError;
use kardashev_app_server_protocol::ListConversationsParams;
use kardashev_app_server_protocol::ListConversationsResponse;
use kardashev_app_server_protocol::ListMcpServersParams;
use kardashev_app_server_protocol::ListMcpServersResponse;
use kardashev_app_server_protocol::LoginAccountParams;
use kardashev_app_server_protocol::LoginApiKeyParams;
use kardashev_app_server_protocol::LoginApiKeyResponse;
use kardashev_app_server_protocol::LoginChatGptCompleteNotification;
use kardashev_app_server_protocol::LoginChatGptResponse;
use kardashev_app_server_protocol::LogoutAccountResponse;
use kardashev_app_server_protocol::LogoutChatGptResponse;
use kardashev_app_server_protocol::McpServer;
use kardashev_app_server_protocol::ModelListParams;
use kardashev_app_server_protocol::ModelListResponse;
use kardashev_app_server_protocol::NewConversationParams;
use kardashev_app_server_protocol::NewConversationResponse;
use kardashev_app_server_protocol::RemoveConversationListenerParams;
use kardashev_app_server_protocol::RemoveConversationSubscriptionResponse;
use kardashev_app_server_protocol::RequestId;
use kardashev_app_server_protocol::ResumeConversationParams;
use kardashev_app_server_protocol::ResumeConversationResponse;
use kardashev_app_server_protocol::ReviewDelivery as ApiReviewDelivery;
use kardashev_app_server_protocol::ReviewStartParams;
use kardashev_app_server_protocol::ReviewStartResponse;
use kardashev_app_server_protocol::ReviewTarget as ApiReviewTarget;
use kardashev_app_server_protocol::SandboxMode;
use kardashev_app_server_protocol::SendUserMessageParams;
use kardashev_app_server_protocol::SendUserMessageResponse;
use kardashev_app_server_protocol::SendUserTurnParams;
use kardashev_app_server_protocol::SendUserTurnResponse;
use kardashev_app_server_protocol::ServerNotification;
use kardashev_app_server_protocol::SessionConfiguredNotification;
use kardashev_app_server_protocol::SetDefaultModelParams;
use kardashev_app_server_protocol::SetDefaultModelResponse;
use kardashev_app_server_protocol::Thread;
use kardashev_app_server_protocol::ThreadArchiveParams;
use kardashev_app_server_protocol::ThreadArchiveResponse;
use kardashev_app_server_protocol::ThreadItem;
use kardashev_app_server_protocol::ThreadListParams;
use kardashev_app_server_protocol::ThreadListResponse;
use kardashev_app_server_protocol::ThreadResumeParams;
use kardashev_app_server_protocol::ThreadResumeResponse;
use kardashev_app_server_protocol::ThreadStartParams;
use kardashev_app_server_protocol::ThreadStartResponse;
use kardashev_app_server_protocol::ThreadStartedNotification;
use kardashev_app_server_protocol::Turn;
use kardashev_app_server_protocol::TurnError;
use kardashev_app_server_protocol::TurnInterruptParams;
use kardashev_app_server_protocol::TurnStartParams;
use kardashev_app_server_protocol::TurnStartResponse;
use kardashev_app_server_protocol::TurnStartedNotification;
use kardashev_app_server_protocol::TurnStatus;
use kardashev_app_server_protocol::UserInfoResponse;
use kardashev_app_server_protocol::UserInput as V2UserInput;
use kardashev_app_server_protocol::UserSavedConfig;
use kardashev_app_server_protocol::build_turns_from_event_msgs;
use kardashev_backend_client::Client as BackendClient;
use kardashev_core::AuthManager;
use kardashev_core::CodexConversation;
use kardashev_core::ConversationManager;
use kardashev_core::Cursor as RolloutCursor;
use kardashev_core::INTERACTIVE_SESSION_SOURCES;
use kardashev_core::InitialHistory;
use kardashev_core::NewConversation;
use kardashev_core::RolloutRecorder;
use kardashev_core::SessionMeta;
use kardashev_core::auth::CLIENT_ID;
use kardashev_core::auth::login_with_api_key;
use kardashev_core::config::Config;
use kardashev_core::config::ConfigOverrides;
use kardashev_core::config::ConfigToml;
use kardashev_core::config::edit::ConfigEditsBuilder;
use kardashev_core::config_loader::load_config_as_toml;
use kardashev_core::default_client::get_kardashev_user_agent;
use kardashev_core::exec::ExecParams;
use kardashev_core::exec_env::create_env;
use kardashev_core::features::Feature;
use kardashev_core::find_conversation_path_by_id_str;
use kardashev_core::git_info::git_diff_to_remote;
use kardashev_core::mcp::collect_mcp_snapshot;
use kardashev_core::mcp::group_tools_by_server;
use kardashev_core::parse_cursor;
use kardashev_core::protocol::EventMsg;
use kardashev_core::protocol::Op;
use kardashev_core::protocol::ReviewDelivery as CoreReviewDelivery;
use kardashev_core::protocol::ReviewRequest;
use kardashev_core::protocol::ReviewTarget as CoreReviewTarget;
use kardashev_core::protocol::SessionConfiguredEvent;
use kardashev_core::read_head_for_summary;
use kardashev_feedback::CodexFeedback;
use kardashev_login::ServerOptions as LoginServerOptions;
use kardashev_login::ShutdownHandle;
use kardashev_login::run_login_server;
use kardashev_protocol::ConversationId;
use kardashev_protocol::config_types::ForcedLoginMethod;
use kardashev_protocol::items::TurnItem;
use kardashev_protocol::models::ResponseItem;
use kardashev_protocol::protocol::GitInfo as CoreGitInfo;
use kardashev_protocol::protocol::McpAuthStatus as CoreMcpAuthStatus;
use kardashev_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use kardashev_protocol::protocol::RolloutItem;
use kardashev_protocol::protocol::SessionMetaLine;
use kardashev_protocol::protocol::USER_MESSAGE_BEGIN;
use kardashev_protocol::user_input::UserInput as CoreInputItem;
use kardashev_utils_json_to_toml::json_to_toml;
...
impl CodexMessageProcessor {
    ...
    fn review_request_from_target(
        ...
        let hint = kardashev_core::review_prompts::user_facing_hint(&core_target);
    ...
    async fn login_api_key_v2(&mut self, request_id: RequestId, params: LoginApiKeyParams) {
        match self.login_api_key_common(&params).await {
            Ok(()) => {
                let response = kardashev_app_server_protocol::LoginAccountResponse::ApiKey {};
        ...
        match self.login_chatgpt_common().await {
            Ok(opts) => match run_login_server(opts) {
                Ok(server) => {
                    ...
                    let response = kardashev_app_server_protocol::LoginAccountResponse::Chatgpt {
    ...
    async fn get_user_saved_config(&self, request_id: RequestId) {
        let toml_value = match load_config_as_toml(&self.config.kardashev_home).await {
            Ok(val) => val,
            Err(err) => {
                let error = JSONRPCErrorError {
                    code: INTERNAL_ERROR_CODE,
    ...
    async fn set_default_model(&self, request_id: RequestId, params: SetDefaultModelParams) {
        ...
        match ConfigEditsBuilder::new(&self.config.kardashev_home)
    ...
    async fn exec_one_off_command(&self, request_id: RequestId, params: CommandExecParams) {
        ...
        let kardashev_linux_sandbox_exe = self.config.kardashev_linux_sandbox_exe.clone();
        let outgoing = self.outgoing.clone();
        let req_id = request_id;
        let sandbox_cwd = self.config.cwd.clone();

        tokio::spawn(async move {
            match kardashev_core::exec::process_exec_tool_call(
                exec_params,
                &effective_policy,
                sandbox_cwd.as_path(),
                &kardashev_linux_sandbox_exe,
    ...
    async fn process_new_conversation(&self, request_id: RequestId, params: NewConversationParams) {
        ...
        let overrides = ConfigOverrides {
            ...
            sandbox_mode,
            model_provider,
            kardashev_linux_sandbox_exe: self.kardashev_linux_sandbox_exe.clone(),
            base_instructions,
            developer_instructions,
            compact_prompt,
            include_apply_patch_tool,
    ...
    fn build_thread_config_overrides(
        ...
        cwd: Option<String>,
        approval_policy: Option<kardashev_app_server_protocol::AskForApproval>,
        ...
        ConfigOverrides {
            ...
            approval_policy: approval_policy
                .map(kardashev_app_server_protocol::AskForApproval::to_core),
        ...
        let path = match params {
            GetConversationSummaryParams::RolloutPath { rollout_path } => {
                if rollout_path.is_relative() {
                    self.config.kardashev_home.join(&rollout_path)
                } else {
                    rollout_path
                }
            }
            GetConversationSummaryParams::ConversationId { conversation_id } => {
                match kardashev_core::find_conversation_path_by_id_str(
                    &self.config.kardashev_home,
                    &conversation_id.to_string(),
                )
                .await
    ...
    async fn archive_conversation_common(
        ...
        let rollout_folder = self.config.kardashev_home.join(kardashev_core::SESSIONS_SUBDIR);
        ...
        let result: std::io::Result<()> = async {
            let archive_folder = self
                .config
                .kardashev_home
                .join(kardashev_core::ARCHIVED_SESSIONS_SUBDIR);
...
fn extract_conversation_summary(
    ...
    let preview = head
        ...
        .find_map(|item| match kardashev_core::parse_turn_item(&item) {
...
mod tests {
    ...
    async fn read_summary_from_rollout_returns_empty_preview_when_no_user_message() -> Result<()> {
        use kardashev_protocol::protocol::RolloutItem;
        use kardashev_protocol::protocol::RolloutLine;
        use kardashev_protocol::protocol::SessionMetaLine;
        use std::fs;
