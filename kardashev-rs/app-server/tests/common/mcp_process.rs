...
use kardashev_app_server_protocol::CancelLoginChatGptParams;
use kardashev_app_server_protocol::ClientInfo;
use kardashev_app_server_protocol::ClientNotification;
...
impl McpProcess {
    pub async fn new(kardashev_home: &Path) -> anyhow::Result<Self> {
        Self::new_with_env(kardashev_home, &[]).await
    }
    ...
    pub async fn new_with_env(
        ...
        cmd.env("KARDASHEV_HOME", kardashev_home);
