...
use crate::version::KARDASHEV_CLI_VERSION;
use crate::wrapping::RtOptions;
use crate::wrapping::word_wrap_line;
use crate::wrapping::word_wrap_lines;
use base64::Engine;
use kardashev_common::format_env_display::format_env_display;
use kardashev_core::config::Config;
use kardashev_core::config::types::McpServerTransportConfig;
use kardashev_core::config::types::ReasoningSummaryFormat;
use kardashev_core::protocol::FileChange;
use kardashev_core::protocol::McpAuthStatus;
    ...
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let content = text![
            line![
                ...
                " ",
                format!("{KARDASHEV_CLI_VERSION} -> {}", self.latest_version).bold(),
            ],
            update_instruction,
            "",
...
pub fn new_approval_decision_cell(
    command: Vec<String>,
    decision: kardashev_core::protocol::ReviewDecision,
) -> Box<dyn HistoryCell> {
...
mod tests {
    ...
    use kardashev_core::config::types::McpServerConfig;
    use kardashev_core::config::types::McpServerTransportConfig;
