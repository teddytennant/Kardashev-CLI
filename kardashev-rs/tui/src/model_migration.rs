...
pub(crate) fn migration_copy_for_config(migration_config_key: &str) -> ModelMigrationCopy {
    match migration_config_key {
        ...
        HIDE_GPT_5_1_KARDASHEV_MAX_MIGRATION_PROMPT_CONFIG => gpt_5_1_kardashev_max_migration_copy(),
        _ => gpt_5_1_kardashev_max_migration_copy(),
    }
}
...
fn gpt_5_1_kardashev_max_migration_copy() -> ModelMigrationCopy {
    ModelMigrationCopy {
...
mod tests {
    ...
    use super::gpt_5_1_kardashev_max_migration_copy;
    ...
    fn prompt_snapshot() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            gpt_5_1_kardashev_max_migration_copy(),
        );
    ...
    #[test]
    fn prompt_snapshot_gpt5_kardashev_mini() {
        let backend = VT100Backend::new(60, 12);
        let mut terminal = Terminal::with_options(backend).expect("terminal");
        terminal.set_viewport_area(Rect::new(0, 0, 60, 12));
        ...
        terminal.flush().expect("flush");
        assert_snapshot!("model_migration_prompt_gpt5_kardashev_mini", terminal.backend());
    }
