...
use kardashev_protocol::custom_prompts::PROMPTS_CMD_PREFIX;
...
mod tests {
    ...
    fn pasting_filepath_attaches_image() {
        ...
        let tmp_path: PathBuf = tmp.path().join("kardashev_tui_test_paste_image.png");
        ...
        assert!(
            composer
                .textarea
                .text()
                .starts_with("[kardashev_tui_test_paste_image.png 3x2] ")
        );
