...
use kardashev_ansi_escape::ansi_escape_line;
...
use kardashev_core::openai_models::model_presets::HIDE_GPT_5_1_KARDASHEV_MAX_MIGRATION_PROMPT_CONFIG;
use kardashev_core::openai_models::model_presets::HIDE_GPT5_1_MIGRATION_PROMPT_CONFIG;
use kardashev_core::openai_models::models_manager::ModelsManager;
use kardashev_core::protocol::EventMsg;
use kardashev_core::protocol::FinalOutput;
use kardashev_core::protocol::Op;
use kardashev_core::protocol::SessionSource;
use kardashev_core::protocol::TokenUsage;
use kardashev_core::skills::load_skills;
...
const GPT_5_1_KARDASHEV_MIGRATION_AUTH_MODES: [AuthMode; 2] = [AuthMode::ChatGPT, AuthMode::ApiKey];
...
fn migration_prompt_hidden(config: &Config, migration_config_key: &str) -> Option<bool> {
    match migration_config_key {
        HIDE_GPT_5_1_KARDASHEV_MAX_MIGRATION_PROMPT_CONFIG => {
            config.notices.hide_gpt_5_1_kardashev_max_migration_prompt
        }
...
impl App {
    ...
    pub async fn run(
        ...
        {
            let should_check = kardashev_core::get_platform_sandbox().is_some()
                && matches!(
                    app.config.sandbox_policy,
                    kardashev_core::protocol::SandboxPolicy::WorkspaceWrite { .. }
                        | kardashev_core::protocol::SandboxPolicy::ReadOnly
                )
                && !app
                    .config
                    .notices
            ...
            if should_check {
                ...
                let logs_base_dir = app.config.kardashev_home.clone();
    ...
    async fn handle_event(&mut self, tui: &mut tui::Tui, event: AppEvent) -> Result<bool> {
        ...
        match event {
            ...
            AppEvent::CodexEvent(event) => {
                ...
                self.chat_widget.handle_kardashev_event(event);
            }
            ...
            AppEvent::UpdateSandboxPolicy(policy) => {
                ...
                #[cfg(target_os = "windows")]
                if !matches!(policy, kardashev_core::protocol::SandboxPolicy::ReadOnly)
                ...
                #[cfg(target_os = "windows")]
                {
                    ...
                    if should_check {
                        ...
                        let tx = self.app_event_tx.clone();
                        let logs_base_dir = self.config.kardashev_home.clone();
            ...
            AppEvent::PersistFullAccessWarningAcknowledged => {
                if let Err(err) = ConfigEditsBuilder::new(&self.config.kardashev_home)
    ...
    pub(crate) fn token_usage(&self) -> kardashev_core::protocol::TokenUsage {
        self.chat_widget.token_usage()
    }
    ...
    fn spawn_world_writable_scan(
        ...
        sandbox_policy: kardashev_core::protocol::SandboxPolicy,
        tx: AppEventSender,
    ) {
        tokio::task::spawn_blocking(move || {
            let result = kardashev_windows_sandbox::apply_world_writable_scan_and_denies(
                &logs_base_dir,
                &cwd,
                &env_map,
                &sandbox_policy,
...
fn migration_prompt_allowed_auth_modes(migration_config_key: &str) -> Option<&'static [AuthMode]> {
    match migration_config_key {
        ...
        HIDE_GPT_5_1_KARDASHEV_MAX_MIGRATION_PROMPT_CONFIG => Some(&GPT_5_1_KARDASHEV_MIGRATION_AUTH_MODES),
        _ => None,
    }
}
...
mod tests {
    ...
    fn all_model_presets() -> Vec<ModelPreset> {
        kardashev_core::openai_models::model_presets::all_model_presets().clone()
    }
    ...
    async fn new_session_requests_shutdown_for_previous_conversation() {
        ...
        app.chat_widget.handle_kardashev_event(Event {
            id: String::new(),
    ...
    #[test]
    fn gpt_5_1_kardashev_max_migration_limits_to_chatgpt() {
        assert!(migration_prompt_allows_auth_mode(
            Some(AuthMode::ChatGPT),
            HIDE_GPT_5_1_KARDASHEV_MAX_MIGRATION_PROMPT_CONFIG,
        ));
