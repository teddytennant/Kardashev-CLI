...
use kardashev_protocol::protocol::AgentReasoningEvent;
use kardashev_protocol::protocol::AgentReasoningRawContentEvent;
use kardashev_protocol::protocol::EventMsg;
use kardashev_protocol::protocol::TurnAbortedEvent;
use kardashev_protocol::protocol::UserMessageEvent;
...
impl ThreadHistoryBuilder {
    ...
    /// See `should_persist_event_msg` in `kardashev-rs/core/rollout/policy.rs`.
...
mod tests {
    use super::*;
    use kardashev_protocol::protocol::AgentMessageEvent;
    use kardashev_protocol::protocol::AgentReasoningEvent;
    use kardashev_protocol::protocol::AgentReasoningRawContentEvent;
