...
use kardashev_execpolicy::Error;
...
use kardashev_execpolicy::RuleRef;
use kardashev_execpolicy::rule::PatternToken;
use kardashev_execpolicy::rule::PrefixPattern;
use kardashev_execpolicy::rule::PrefixRule;
...
prefix_rule(
    ...
    parser.parse("test.kardashevpolicy", policy_src)?;
...
prefix_rule(
    ...
    "#;
    let mut parser = PolicyParser::new();
    parser.parse("first.kardashevpolicy", first_policy)?;
    parser.parse("second.kardashevpolicy", second_policy)?;
    let policy = parser.build();
