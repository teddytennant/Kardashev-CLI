...
use kardashev_core::default_client::originator;
use kardashev_core::token_data::TokenData;
use kardashev_core::token_data::parse_id_token;
use rand::RngCore;
...
fn build_authorize_url(
    ...
    let mut query = vec![
        ...
        ("kardashev_cli_simplified_flow".to_string(), "true".to_string()),
...
pub(crate) async fn persist_tokens_async(
    ...
    tokio::task::spawn_blocking(move || {
        ...
        save_auth(&kardashev_home, &auth, auth_credentials_store_mode)
    })
    .await
