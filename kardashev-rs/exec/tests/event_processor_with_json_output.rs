...
use kardashev_core::protocol::PatchApplyEndEvent;
...
use kardashev_exec::event_processor_with_jsonl_output::EventProcessorWithJsonOutput;
use kardashev_exec::exec_events::AgentMessageItem;
use kardashev_exec::exec_events::CommandExecutionItem;
use kardashev_exec::exec_events::CommandExecutionStatus;
use kardashev_exec::exec_events::ErrorItem;
use kardashev_exec::exec_events::ItemCompletedEvent;
use kardashev_exec::exec_events::ItemStartedEvent;
use kardashev_exec::exec_events::ItemUpdatedEvent;
use kardashev_exec::exec_events::McpToolCallItem;
use kardashev_exec::exec_events::McpToolCallItemError;
use kardashev_exec::exec_events::McpToolCallItemResult;
use kardashev_exec::exec_events::McpToolCallStatus;
use kardashev_exec::exec_events::PatchApplyStatus;
use kardashev_exec::exec_events::PatchChangeKind;
use kardashev_exec::exec_events::ReasoningItem;
use kardashev_exec::exec_events::ThreadErrorEvent;
use kardashev_exec::exec_events::ThreadEvent;
use kardashev_exec::exec_events::ThreadItem;
use kardashev_exec::exec_events::ThreadItemDetails;
use kardashev_exec::exec_events::ThreadStartedEvent;
use kardashev_exec::exec_events::TodoItem as ExecTodoItem;
use kardashev_exec::exec_events::TodoListItem as ExecTodoListItem;
use kardashev_exec::exec_events::TurnCompletedEvent;
use kardashev_exec::exec_events::TurnFailedEvent;
use kardashev_exec::exec_events::TurnStartedEvent;
use kardashev_exec::exec_events::Usage;
use kardashev_exec::exec_events::WebSearchItem;
...
fn session_configured_produces_thread_started_event() {
    ...
    let session_id =
        kardashev_protocol::ConversationId::from_string("67e55044-10b1-426f-9247-bb680e5fe0c8")
            .unwrap();
...
fn task_started_produces_turn_started_event() {
    ...
    let out = ep.collect_thread_events(&event(
        "t1",
        EventMsg::TaskStarted(kardashev_core::protocol::TaskStartedEvent {
...
fn plan_update_emits_todo_list_started_updated_and_completed() {
    ...
    let complete = event(
        "p3",
        EventMsg::TaskComplete(kardashev_core::protocol::TaskCompleteEvent {
...
fn error_event_produces_error() {
    ...
    let out = ep.collect_thread_events(&event(
        "e1",
        EventMsg::Error(kardashev_core::protocol::ErrorEvent {
...
fn stream_error_event_produces_error() {
    ...
    let out = ep.collect_thread_events(&event(
        "e1",
        EventMsg::StreamError(kardashev_core::protocol::StreamErrorEvent {
...
fn task_complete_produces_turn_completed_with_usage() {
    ...
    let usage = kardashev_core::protocol::TokenUsage {
        input_tokens: 1200,
    ...
    let info = kardashev_core::protocol::TokenUsageInfo {
    ...
    let token_count_event = event(
        "e1",
        EventMsg::TokenCount(kardashev_core::protocol::TokenCountEvent {
            info: Some(info),
            rate_limits: None,
        }),
    );
