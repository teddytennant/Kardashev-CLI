use kardashev_common::elapsed::format_duration;
use kardashev_common::elapsed::format_elapsed;
...
use kardashev_protocol::num_format::format_with_separators;
...
use kardashev_common::create_config_summary_entries;
...
pub(crate) struct EventProcessorWithHumanOutput {
    ...
    last_total_token_usage: Option<kardashev_core::protocol::TokenUsageInfo>,
        ...
        match msg {
            ...
            EventMsg::McpStartupUpdate(update) => {
                let status_text = match update.status {
                    kardashev_core::protocol::McpStartupStatus::Starting => "starting".to_string(),
                    kardashev_core::protocol::McpStartupStatus::Ready => "ready".to_string(),
                    kardashev_core::protocol::McpStartupStatus::Cancelled => "cancelled".to_string(),
                    kardashev_core::protocol::McpStartupStatus::Failed { ref error } => {
                        format!("failed: {error}")
                    }
                };
                ts_msg!(
