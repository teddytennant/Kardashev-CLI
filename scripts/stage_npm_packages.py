...
BUILD_SCRIPT = REPO_ROOT / "kardashev-cli" / "scripts" / "build_npm_package.py"
INSTALL_NATIVE_DEPS = REPO_ROOT / "kardashev-cli" / "scripts" / "install_native_deps.py"
WORKFLOW_NAME = ".github/workflows/rust-release.yml"
GITHUB_REPO = "openai/kardashev"

_SPEC = importlib.util.spec_from_file_location("kardashev_build_npm_package", BUILD_SCRIPT)
